...
export const GEAR: Record<'trek' | 'journee', GearMode> = {
  trek:{
    indispensable:[
      {id:'chaussures',name:'Chaussures de rando · Quechua MH500 imperméables',note:'Porté sur soi · 860 g la paire en 43',price:'80–180€',weight:'650–900 g',worn:true,links:[{l:'MH500 imperméables',u:'https://www.decathlon.fr/p/chaussures-de-randonnee-impermeables-homme-mh500/_/R-p-330812'}]},
      {id:'batons',name:'Bâtons de rando · Forclaz MT500 (x2)',note:'Portés en main · 240 g le bâton, vendus à l’unité',price:'30–90€',weight:'470–490 g',worn:true,links:[{l:'MT500 réglage rapide',u:'https://www.decathlon.fr/p/1-baton-reglage-rapide-et-precis-de-randonnee-mt500-gris/_/R-p-173277'}]},
      ...
      {id:'powerbank',name:'Power bank 10 000 mAh USB-C',note:null,price:'20–60€',weight:'180–280 g',links:[{l:'Amazon',u:'https://www.amazon.fr/s?k=powerbank+10000mah+usb-c+leger+randonnee'}]},
      ...
      {id:'chaussettes',name:'Chaussettes trek Merinos (x2 paires)',note:'Portées sur soi · séchage rapide, éviter le coton',price:'8–20€',weight:'120–160 g',worn:true,links:[{l:'Chaussettes trek',u:'https://www.decathlon.fr/tous-les-sports/randonnee-trek/chaussettes-randonnee'}]},
    ...
    facultatif:[
      ...
      {id:'crampons',name:'Mini-crampons rando · Simond Bobcat',note:'Début/fin de saison · 420 g, 465 g avec housse',price:'15–40€',weight:'420–465 g',links:[{l:'Simond Bobcat',u:'https://www.decathlon.fr/p/mini-crampons-d-appoint-pour-randonnee-bobcat/_/R-p-342903'}]},
  ...
  journee:{
    indispensable:[
      {id:'chaussures',name:'Chaussures de rando · Quechua MH500 imperméables',note:'Porté sur soi · 860 g la paire en 43',price:'60–150€',weight:'650–900 g',worn:true,links:[{l:'MH500 imperméables',u:'https://www.decathlon.fr/p/chaussures-de-randonnee-impermeables-homme-mh500/_/R-p-330812'}]},
      {id:'batons',name:'Bâtons de marche · Forclaz MT500 (x2)',note:'Portés en main · 240 g le bâton, vendus à l’unité',price:'25–70€',weight:'470–490 g',worn:true,links:[{l:'MT500 réglage rapide',u:'https://www.decathlon.fr/p/1-baton-reglage-rapide-et-precis-de-randonnee-mt500-gris/_/R-p-173277'}]},
    ...
    recommande:[
      ...
      {id:'chaussettes',name:'Chaussettes trek Merinos',note:'Portées sur soi · éviter le coton',price:'8–18€',weight:'60–80 g',worn:true,links:[{l:'Chaussettes trek',u:'https://www.decathlon.fr/tous-les-sports/randonnee-trek/chaussettes-randonnee'}]},
      ...
      {id:'powerbank',name:'Power bank 10 000 mAh USB-C',note:null,price:'20–50€',weight:'180–280 g',links:[{l:'Amazon',u:'https://www.amazon.fr/s?k=powerbank+10000mah+usb-c+leger+randonnee'}]},
    ],
    facultatif:[
      {id:'poncho',name:'Poncho pluie',note:null,price:'10–30€',weight:'340–380 g',links:[{l:'Ponchos',u:'https://www.decathlon.fr/tous-les-sports/randonnee-trek/ponchos-capes-de-pluie'}]},
      {id:'crampons',name:'Mini-crampons rando · Simond Bobcat',note:'Début/fin de saison · 6 pointes',price:'15–35€',weight:'420–465 g',links:[{l:'Simond Bobcat',u:'https://www.decathlon.fr/p/mini-crampons-d-appoint-pour-randonnee-bobcat/_/R-p-342903'}]},
    ]
  }
};
